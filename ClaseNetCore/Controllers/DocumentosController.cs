...
namespace ClaseNetCore.Controllers
{
    public class DocumentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Codigo,Descripcion,Estado")] Documento documento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Codigo,Descripcion,Estado")] Documento documento)
        {
        ...
        {
            return _context.Documento.Any(e => e.Codigo == id);
        }
    }
}
